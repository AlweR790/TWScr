var ScriptData = { name: "Auto notes from report", version: "v2.1", lastUpdate: "2021-03-07", author: "xdam98", authorContact: "Xico#7941 (Discord)" },
    LS_prefix = "xd",
    translations = {
        pt_PT: {
        ...
        pl_PL: {
            unknown: "Nieznany",
            verifyReportPage: "Ten skrypt moÅ¼na uruchomiÄ‡ tylko na ekranie raportu.",
            offensive: "Ofensywna",
    ...
    initTranslations = () =>
        localStorage.getItem(`${LS_prefix}_langWarning`)
            ? 1
            : (void 0 === translations[game_data.locale] && UI.ErrorMessage(`No translation found for <b>${game_data.locale}</b>.`, 3e3), localStorage.setItem(`${LS_prefix}_langWarning`, 1), 0);
(CriarRelatorioNotas = {
    dados: {
        player: { nomePlayer: game_data.player.name, playerEstaAtacar: !1, playerEstaDefender: !1, playerQuerInfoAtacante: !1, playerQuerInfoDefensor: !1 },
        aldeia: {
            ofensiva: { idAldeia: "-1", tipoAldeia: _t("unknown"), tropas: { totais: [], ofensivas: 0, defensivas: 0 } },
            defensiva: {
                idAldeia: "-1",
                tipoAldeia: _t("unknown"),
                tropas: { visiveis: !1, totais: [], fora: { visiveis: !1, ofensivas: 0, defensivas: 0, totais: [] }, dentro: { ofensivas: 0, defensivas: 0, totais: [] }, apoios: 0 },
                edificios: { edificiosVisiveis: !1, torre: [!1, 0], igrejaPrincipal: [!1, 0], igreja: [!1, 0], muralha: [!1, 0] },
            },
        },
        ...
        "0" != game_data.player.sitter && (s = 4),
                ...
                this.dados.mundo.arqueirosAtivos
                    ? $("#attack_spy_away > tbody > tr:nth-child(2) > td > table > tbody > tr:nth-child(2) > td").each(function (e, i) {
                          ...
                          e < a.dados.aldeia.defensiva.tropas.totais.length && (a.dados.aldeia.defensiva.tropas.fora.totais[e] = s),
                              2 == e || 5 == e || 6 == e || 8 == e
                                  ? (a.dados.aldeia.defensiva.tropas.fora.ofensivas += s * a.dados.mundo.fazendaPorTropa[e])
                                  : (0 != e && 1 != e && 3 != e && 7 != e && 9 != e) || (a.dados.aldeia.defensiva.tropas.fora.defensivas += s * a.dados.mundo.fazendaPorTropa[e]);
                      })
                    : $("#attack_spy_away > tbody > tr:nth-child(2) > td > table > tbody > tr:nth-child(2) > td").each(function (e, i) {
                          var s = parseInt(i.textContent);
                          e < a.dados.aldeia.defensiva.tropas.totais.length && (a.dados.aldeia.defensiva.tropas.fora.totais[e] = s),
                              2 == e || 4 == e || 6 == e
                                  ? (a.dados.aldeia.defensiva.tropas.fora.ofensivas += s * a.dados.mundo.fazendaPorTropa[e])
                                  : (0 != e && 1 != e && 5 != e && 7 != e) || (a.dados.aldeia.defensiva.tropas.fora.defensivas += s * a.dados.mundo.fazendaPorTropa[e]);
                      })),
            ...
            this.dados.mundo.arqueirosAtivos
                ? (this.dados.aldeia.defensiva.tropas.visiveis &&
                      $("#attack_info_def_units > tbody > tr:nth-child(2) > td.unit-item").each(function (e, i) {
                          var s = parseInt(i.textContent);
                          e < a.dados.aldeia.defensiva.tropas.totais.length && (a.dados.aldeia.defensiva.tropas.dentro.totais[e] = s),
                              2 == e || 5 == e || 6 == e || 8 == e
                                  ? (a.dados.aldeia.defensiva.tropas.dentro.ofensivas += s * a.dados.mundo.fazendaPorTropa[e])
                                  : (0 != e && 1 != e && 3 != e && 7 != e && 9 != e) || (a.dados.aldeia.defensiva.tropas.dentro.defensivas += s * a.dados.mundo.fazendaPorTropa[e]);
                      }),
                  $("#attack_info_att_units > tbody > tr:nth-child(2) > td.unit-item").each(function (e, i) {
                      ...
                      e < a.dados.aldeia.ofensiva.tropas.totais.length && (a.dados.aldeia.ofensiva.tropas.totais[e] = s),
                          2 == e || 5 == e || 6 == e
                              ? (a.dados.aldeia.ofensiva.tropas.ofensivas += s * a.dados.mundo.fazendaPorTropa[e])
                              : (0 != e && 1 != e && 3 != e && 7 != e && 9 != e) || (a.dados.aldeia.ofensiva.tropas.defensivas += s * a.dados.mundo.fazendaPorTropa[e]);
                  }))
                : (this.dados.aldeia.defensiva.tropas.visiveis &&
                      $("#attack_info_def_units > tbody > tr:nth-child(2) > td.unit-item").each(function (e, i) {
                          var s = parseInt(i.textContent);
                          e < a.dados.aldeia.defensiva.tropas.totais.length && (a.dados.aldeia.defensiva.tropas.dentro.totais[e] = s),
                              2 == e || 4 == e || 6 == e
                                  ? (a.dados.aldeia.defensiva.tropas.dentro.ofensivas += s * a.dados.mundo.fazendaPorTropa[e])
                                  : (0 != e && 1 != e && 5 != e && 7 != e) || (a.dados.aldeia.defensiva.tropas.dentro.defensivas += s * a.dados.mundo.fazendaPorTropa[e]);
                      }),
                  $("#attack_info_att_units > tbody > tr:nth-child(2) > td.unit-item").each(function (e, i) {
                      var s = parseInt(i.textContent);
                      e < a.dados.aldeia.ofensiva.tropas.totais.length && (a.dados.aldeia.ofensiva.tropas.totais[e] = s),
                          2 == e || 4 == e || 6 == e
                              ? (a.dados.aldeia.ofensiva.tropas.ofensivas += s * a.dados.mundo.fazendaPorTropa[e])
                              : (0 != e && 1 != e && 5 != e && 7 != e) || (a.dados.aldeia.ofensiva.tropas.defensivas += s * a.dados.mundo.fazendaPorTropa[e]);
                  })),
        ...
        this.dados.aldeia.defensiva.tropas.visiveis
            ...
            this.dados.aldeia.defensiva.tropas.fora.visiveis &&
                (this.dados.aldeia.defensiva.tropas.fora.ofensivas > 3e3
                    ...
                    : this.dados.aldeia.defensiva.tropas.fora.defensivas + this.dados.aldeia.defensiva.tropas.fora.ofensivas > 1e3 &&
                      (this.dados.aldeia.defensiva.tropas.fora.ofensivas > this.dados.aldeia.defensiva.tropas.fora.defensivas
                          ? (this.dados.aldeia.defensiva.tipoAldeia = _t("probOffensive"))
                          : this.dados.aldeia.defensiva.tropas.fora.defensivas >= this.dados.aldeia.defensiva.tropas.fora.ofensivas && (this.dados.aldeia.defensiva.tipoAldeia = _t("probDefensive"))),
                (this.dados.aldeia.defensiva.tropas.apoios += Math.round((this.dados.aldeia.defensiva.tropas.fora.defensivas / 2e4) * 10) / 10)),
            this.dados.aldeia.ofensiva.tropas.ofensivas > this.dados.aldeia.ofensiva.tropas.defensivas
                ? (this.dados.aldeia.ofensiva.tipoAldeia = _t("offensive"))
                : this.dados.aldeia.ofensiva.tropas.ofensivas < this.dados.aldeia.ofensiva.tropas.defensivas && (this.dados.aldeia.ofensiva.tipoAldeia = _t("defensive"));
    },
    geraTextoNota: function () {
        ...
        return (
            ...
            (this.dados.player.playerEstaAtacar || this.dados.player.playerQuerInfoDefensor) &&
                (this.dados.aldeia.defensiva.edificios.torre[0] && (s += "[building]watchtower[/building] " + _t("watchtower") + this.dados.aldeia.defensiva.edificios.torre[1] + " | "),
                ...
                this.dados.aldeia.defensiva.edificios.igrejaPrincipal[0] && (s += "[building]church_f[/building] " + _t("firstChurch") + " | "),
                this.dados.aldeia.defensiva.edificios.igreja[0] && (s += "[building]church_f[/building] " + _t("church") + " " + this.dados.aldeia.defensiva.edificios.igreja[1] + " | "),
    ...
    escreveNota: function () {
        var a,
            ...
            s = "";
        if (
            ((s = this.dados.player.playerEstaAtacar || this.dados.player.playerQuerInfoDefensor ? parseInt(this.dados.aldeia.defensiva.idAldeia) : parseInt(this.dados.aldeia.ofensiva.idAldeia)),
            (e =
            ...
            Dialog.show("relatorio_notas", o),
                d.find("button.atk").click(function () {
                    (i.dados.player.playerQuerInfoAtacante = !0),
                        (a = i.geraTextoNota()),
                        $.post(e, { note: a, village_id: i.dados.aldeia.ofensiva.idAldeia, h: game_data.csrf }, function (a) {
                            UI.SuccessMessage(_t("noteCreated"), 2e3);
                        }),
                        Dialog.close();
                }),
                d.find("button.def").click(function () {
                    (i.dados.player.playerQuerInfoDefensor = !0),
                        (a = i.geraTextoNota()),
                        $.post(e, { note: a, village_id: i.dados.aldeia.defensiva.idAldeia, h: game_data.csrf }, function (a) {
                            UI.SuccessMessage(_t("noteCreated"), 2e3);
                        }),
                        Dialog.close();
                });
